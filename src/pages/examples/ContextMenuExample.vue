...
<template>
  <div class="space-y-8">
    <div>
      <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Context Menu</h1>
      <p class="text-gray-500 mt-1 dark:text-gray-400">Right-click context menu component.</p>
    </div>
