...
import { BaseAvatar, BaseInput } from '@purdia/ui'
        ...
        <form class="flex items-center gap-3" @submit.prevent="sendMessage">
          ...
          <div class="flex-1 relative">
            <input
              ...
              class="w-full px-4 py-2.5 text-sm rounded-full border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
          ...
          <button
            type="submit"
            class="p-2.5 bg-primary-600 hover:bg-primary-700 text-white rounded-full transition-colors disabled:opacity-50"
