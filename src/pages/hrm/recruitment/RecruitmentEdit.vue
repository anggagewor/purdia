...
function handleSave() {
  router.push(`/hrm/recruitment/${route.params.id}`)
}
</script>
...
<template>
  <div class="space-y-6">
    <div class="flex items-center gap-3">
      ...
      />
      <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Job Posting</h1>
        <p class="text-gray-500 dark:text-gray-400 mt-1">Update recruitment posting information.</p>
      </div>
    </div>
