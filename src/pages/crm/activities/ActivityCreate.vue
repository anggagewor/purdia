...
const form = ref({
  ...
  subject: '',
  contact: '' as string | number,
  deal: '' as string | number,
  date: '',
  status: 'planned' as string | number,
  notes: '',
})
...
<template>
  <div class="space-y-6">
    <div class="flex items-center gap-3">
      ...
      />
      <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Log Activity</h1>
        <p class="text-gray-500 mt-1">Record a new sales activity.</p>
      </div>
    </div>
    ...
    <div class="flex justify-end gap-2">
      ...
      <BaseButton @click="handleSave">Save Activity</BaseButton>
    </div>
  </div>
</template>
