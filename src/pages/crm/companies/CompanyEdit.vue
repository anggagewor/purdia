...
const form = ref({
  ...
  industry: 'technology' as string | number,
...
function handleSave() {
  router.push(`/crm/companies/${route.params.id}`)
}
</script>
...
<template>
  <div class="space-y-6">
    <div class="flex items-center gap-3">
      ...
      />
      <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Company</h1>
        <p class="text-gray-500 mt-1">Update company information.</p>
      </div>
    </div>
